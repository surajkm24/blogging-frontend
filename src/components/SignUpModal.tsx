                    ...
                    <ModalBody>
                        <Box display='flex' flexDir='column' gap='10px' alignItems='center' mt={{ base: 5, md: 10 }}>
                            <Button borderColor='rgba(0,0,0,0.3)' variant='outline' display='flex'
                                justifyContent='flex-start' alignItems='center' gap='8px' fontSize='14px'
                        ...
                        <Text mt={{ base: 4, md: 8 }} display='flex' alignItems='center' gap='4px' justifyContent='center' fontSize='16px' fontWeight={500}>Already have an account?<Button variant='unstyled' color='green' fontWeight={700} _hover={{ color: "darkgreen" }} onClick={() => {
                            onClose();
                            onOpen();
                        }}>Sign in</Button></Text>
                        <Text mt={{ base: 10, md: 20 }} w='80%' mb={{ base: 4, md: 8 }} mx='auto' fontSize='14px' lineHeight='20px' textAlign='center' color='rgba(0,0,0,0.7)'>
